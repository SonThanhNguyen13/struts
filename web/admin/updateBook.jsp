<%-- 
    Document   : updateBook
    Created on : Sep 20, 2021, 10:33:40 AM
            ...
            <form action="updateBook" method="POST"  enctype="multipart/form-data">
                ...
                <div class="update-form">
                    <div class="form-left col-6 text-center">        
                        <label for="avatar" class="label">Image:</label><br/>
                        <img src="<%=request.getContextPath()%>/<s:property value='image'/>" width="200px" height="400px" class="mb-2" /><br/>
                        <s:file name="bookImage"/><br/>
                    </div>
                    <div class="form-right">        
                        <s:textfield type="hidden" name="userID"/>
                        <div class="form-group">
                            <label for="username">Name</label>
                            <s:textfield name="name" cssClass="form-control" size="100" />
                        </div>
                        <div class="form-group">
                            <label for="username">Author</label>
                            <s:textfield name="author" cssClass="form-control"/>
                        </div>
                        <div class="form-group">
                            <label for="username">Description</label>
                            <s:textarea name="description" cssClass="form-control" rows="9"/>
                        </div>
                    </div>
                </div>

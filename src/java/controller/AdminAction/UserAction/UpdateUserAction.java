...
public class UpdateUserAction extends ActionSupport {
    ...
    private String getUserByID(int id) throws SQLException, ClassNotFoundException {
        ...
        if (!userInfo.equals("")) {
            ...
            setUsername(parts[1]);
            setIsAdmin(Boolean.parseBoolean(parts[3]));
            setEmail(parts[4]);
            setName(parts[5]);
    ...
    public String updateUser() throws SQLException, ClassNotFoundException, NoSuchAlgorithmException, IOException, InterruptedException {
        try {
            this.id = Integer.parseInt(this.userID);
